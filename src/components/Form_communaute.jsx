  ...
  return (
    <div>
      <form className='form_module' onSubmit={handleSubmit}>
        ...
        <input type="text" name="description" id="" className='form-control' value={formData.description} onChange={handleChange} />
        <label htmlFor="statut">Statut de la communauté</label>
        <select name="statut" id="" className='form-control' value={formData.statut} onChange={handleChange}>
          <option value="privé">Privé</option>
          <option value="public">Public</option>
        </select>
        <label htmlFor="category">Catégorie de la communauté</label>
        <select name="category" id="" className='form-control' value={formData.category} onChange={handleChange}>
        ...
        <input type="file" name="photo_communaute" id="" className='form-control' onChange={handleChange} />
        <label htmlFor="border">Couleur de bordure de la photo</label><br />
        <input type="color" name="border" id="" value={formData.border} onChange={handleChange}/><br />
        <label htmlFor='regles'>Règles de la communauté</label>
        <textarea name="regles" id="" className='form-control' rows={4} value={formData.regles} onChange={handleChange}></textarea>
